...
import com.agent.prompt.PromptBuilder.Section;
import  com.agent.prompt.PromptBuilder.EnvironmentContext;
/**
 * 内容生产者：预定义 8 个固定提示词段落，每个带优先级
 */
public final class PromptSections {
    ...
    static final String IDENTITY_CONTENT = """
            You are DeveCode, an AI programming assistant running in the terminal. You help users with \
