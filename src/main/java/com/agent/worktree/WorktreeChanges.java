...
/**
 * 子 Agent结束后判断worktree里到底有没有产生需要保留的东西
 */
public final class WorktreeChanges {
    ...
    /**
     * 相比于hasChanges返回更详细的版本,包括文件改变行数和新commit数
     */
